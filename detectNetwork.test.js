...
describe('China UnionPay', function() {
  ...
  for (var prefix = 624; prefix <= 626; prefix++) {
    (function() {
      var testString = prefix.toString() + '1234567890123'
      it('has a prefix of ' + prefix.toString() + ' and a length of 16', function() {
        expect(detectNetwork(testString)).to.equal('China UnionPay');
      });
    })();
  }
  ...
  for (var prefix = 624; prefix <= 626; prefix++) {
    (function() {
      var testString = prefix.toString() + '12345678901234'
  ...
  for (var prefix = 624; prefix <= 626; prefix++) {
    (function() {
      var testString = prefix.toString() + '123456789012345'
  ...
  for (var prefix = 624; prefix <= 626; prefix++) {
    (function() {
      var testString = prefix.toString() + '1234567890123456'
  ...
  for (var prefix = 6282; prefix <= 6288; prefix++) {
    (function() {
      var testString = prefix.toString() + '123456789012'
      it('has a prefix of ' + prefix.toString() + ' and a length of 16', function() {
        expect(detectNetwork(testString)).to.equal('China UnionPay');
      });
    })();
  ...
  for (var prefix = 622126; prefix <= 622925; prefix++) {
      (function() {
	var testString = prefix.toString() + "1234567890"
	it('has a prefix of ' + prefix.toString() + ' and a length of 16', function() {
	  expect(detectNetwork(testString)).to.equal('China UnionPay');
        });
      })();
  ...
  for (var prefix = 622126; prefix <= 622925; prefix++) {
      (function() {
	var testString = prefix.toString() + "12345678901"
	it('has a prefix of ' + prefix.toString() + ' and a length of 17', function() {
	  expect(detectNetwork(testString)).to.equal('China UnionPay');
        });
      })();
